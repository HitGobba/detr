        ...
        if args.output_dir and utils.is_main_process():
            ...
            if coco_evaluator is not None:
                ...
                if "bbox" in coco_evaluator.coco_eval:
                    ...
                    # top epoch
                    if test_stats['coco_eval_bbox'][0]*0.9 + \
                    test_stats['coco_eval_bbox'][1]*0.1 > top_fit:
                        top_fit = test_stats['coco_eval_bbox'][0]*0.9 + \
                        test_stats['coco_eval_bbox'][1]*0.1
                        top_epoch = epoch
                        utils.save_on_master({
                            'model': model_without_ddp.state_dict(),
                            'optimizer': optimizer.state_dict(),
                            ...
                            'epoch': epoch,
                            'args': args,
                        }, output_dir / f'bestcheckpoint.pth')
